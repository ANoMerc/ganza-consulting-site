...
(function () {
  ...
  // Аналитика никогда не должна конкурировать с отрисовкой первого экрана.
  // Всё, что ниже, запускается в простое браузера; на слабых устройствах это
  // разница между «страница отзывается» и «страница думает».
  ...
  // --- 1. page view ---------------------------------------------------------
  // В простое: просмотр всё равно будет засчитан, но не за счёт первого экрана.
  whenIdle(function () { send("page_view"); });
